...
export function createMockMistralResponse(content = 'Test response', options = {}) {
  return {
    id: `mistral-${Date.now()}`,
...
export function createMockMistralError(type = 'invalid_api_key', message = null) {
  const errors = {
    invalid_api_key: {
