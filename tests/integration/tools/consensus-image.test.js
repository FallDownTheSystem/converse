...
describe('Consensus Tool Image Processing', () => {
  ...
  testWithApiKeys({ requiredProviders: ['OPENAI', 'XAI', 'GOOGLE'], requireAll: true })('should process image with all three providers', async () => {
  ...
  testWithApiKeys({ requiredProviders: ['OPENAI', 'XAI', 'GOOGLE'] })('should handle image with any available provider', async () => {
    await withHTTPTestServer(async (client, manager) => {
  ...
  testWithApiKeys({ requiredProviders: ['OPENAI'], requireAll: true })('should handle image with complex content array', async () => {
    await withHTTPTestServer(async (client, manager) => {
