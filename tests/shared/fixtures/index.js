...
export const errors = {
  ...
  validation: {
    ...
    invalidType: new Error('Invalid parameter type: expected string, got number'),
...
export const prompts = {
  simple: 'What is 2+2?',
  complex: 'Explain the concept of recursion in computer science with examples.',
  multiline: `Please analyze the following code:
function factorial(n) {
  if (n <= 1) return 1;
  return n * factorial(n - 1);
}`,
  withContext: 'Based on the provided file, what is the main purpose of the function?',
  consensus: 'Should we use microservices or monolithic architecture for our e-commerce platform?'
};
...
export const models = {
  ...
  intelligent: ['gpt-4', 'gemini-2.5-pro', 'grok-2', 'claude-3-5-sonnet-20241022'],
